...
// after models loading in app.js, we can get models via mongoose.model
	...
	describe('Model User:', function() {
		...
		describe('User save', function() {
			...
			it('should password be hashed correctly', function(done) {
				...
				_user.save(function(err) {
					should.not.exist(err)
					_user.passwd.should.not.have.length(0)

					bcrypt.compare(passwd, _user.passwd, function(err, isMatch) {
						should.not.exist(err)
